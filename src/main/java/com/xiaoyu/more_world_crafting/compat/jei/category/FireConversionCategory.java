...
public class FireConversionCategory implements IRecipeCategory<FireConversionRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(MoreWorldCrafting.MODID, "fire_conversion");
    public static final RecipeType<FireConversionRecipe> FIRE_CONVERSION_TYPE = new RecipeType<>(UID, FireConversionRecipe.class);
    ...
    public FireConversionCategory(IGuiHelper helper) {
        ...
        this.icon = JEIBurningAnimation.create(helper, FireConversionRecipe.FireType.NORMAL_FIRE);
    ...
    @Override
    public RecipeType<FireConversionRecipe> getRecipeType() {
        return FIRE_CONVERSION_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.more_world_crafting.fire_conversion");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FireConversionRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(FireConversionRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
