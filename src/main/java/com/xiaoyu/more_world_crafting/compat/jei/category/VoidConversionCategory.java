...
public class VoidConversionCategory implements IRecipeCategory<VoidConversionRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(MoreWorldCrafting.MODID, "void_conversion");
    ...
    public Component getTitle() {
        return Component.translatable("jei.more_world_crafting.void_conversion");
    }
