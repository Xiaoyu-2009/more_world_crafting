...
import com.xiaoyu.more_world_crafting.compat.crafttweaker.actions.AddExplosionConversionRecipeAction;
import org.openzen.zencode.java.ZenCodeType;

@ZenRegister
@ZenCodeType.Name("mods.more_world_crafting.ExplosionConversionManager")
@Document("mods/more_world_crafting/ExplosionConversionManager")
public class ExplosionConversionManager {
    ...
    public void addRecipe(String name, IItemStack ingredient, IItemStack result, float successChance) {
        ...
        CraftTweakerAPI.apply(new AddExplosionConversionRecipeAction(recipeId, ingredient, result, successChance));
    }
