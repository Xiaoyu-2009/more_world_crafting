...
public class FireConversionRecipe implements Recipe<Container> {
    ...
    public FireConversionRecipe(ResourceLocation id, Ingredient ingredient, ItemStack result, 
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipeSerializers.FIRE_CONVERSION_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ModRecipeTypes.FIRE_CONVERSION.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<FireConversionRecipe> {
        ...
        @Override
        public @Nullable FireConversionRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
